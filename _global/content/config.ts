...
export const cardImageSchema = (image: ImageFunction) => z.preprocess(
...
export const meetingsSchema = ({ image }) => z.object({
  title: z.string(),
  ...
  timezone: z.string().default(timezone), // IANA timezone to display on site (maybe remove this and show local timezone instead)
...
export const profilesSchema = ({ image }) => z.object({
  name: z.string(),
...
export const eventsSchema = ({ image }) => z.object({
  title: z.string(),
  series: z.string(),
...
export const publicationsSchema = ({ image }) => z.object({
  title: z.string(),
